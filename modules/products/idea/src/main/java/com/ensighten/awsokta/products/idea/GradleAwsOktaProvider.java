...
public class GradleAwsOktaProvider implements GradleExecutionEnvironmentProvider {
    ...
    private void applyEnvFile(final ApplicationConfiguration sourceConfig, final GradleRunConfiguration targetConfig) {
        ...
        try {
            newEnv = new AwsOktaEnvironmentVariables(
                    RunConfigSettingsEditor.getAwsOktaSettings(sourceConfig)
            )
                    .render(
